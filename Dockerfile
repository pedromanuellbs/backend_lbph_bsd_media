...
# 4. "Panggang" model SFace (ringan) ke dalam image
RUN mkdir -p /root/.deepface/weights \
 && wget -q -O /root/.deepface/weights/sface_weights.h5 https://github.com/serengil/deepface_models/releases/download/v1.0/sface_weights.h5
