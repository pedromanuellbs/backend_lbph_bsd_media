...
def is_face_match(user_face_img, target_img, threshold=100): # <--- THRESHOLD DEFAULT DIUBAH KE 120
...
def find_matching_photos(user_face_path, folder_id, threshold=100): # <--- THRESHOLD DEFAULT DIUBAH KE 120
...
def find_all_matching_photos(user_face_path, all_folder_ids, threshold=100): # <--- THRESHOLD DEFAULT DIUBAH KE 120
    all_matches = []
