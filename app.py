...
def find_my_photos():
    try:
        ...
        # Get folder ids
        all_folder_ids_and_session_ids = get_all_gdrive_folder_ids()
        print(f"DEBUG: Ditemukan {len(all_folder_ids_and_session_ids)} folder Google Drive.")

        # matches = find_all_matching_photos(user_tmp, all_folder_ids, threshold=70)
        matches = find_all_matching_photos(user_tmp, all_folder_ids_and_session_ids)
